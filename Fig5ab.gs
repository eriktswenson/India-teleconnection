...
'set xlopts 1 3 0.15'
'set ylopts 1 3 0.15'
'set xlabs 120E|140E|160E|180|160W|140W|120W|100W|80W'
'set ylabs |10S||EQ||10N||20N'

'set clevs -0.6 -0.4 -0.2 0.2 0.4 0.6 0.8'
'set ccols 43 42 41 0 21 22 23 24'
'd 'sign'*dt'
'set gxout contour'
...
'draw string 0.6 10.4 (a) ENSO mode'
'draw string 0.6 3.4 (b)'
